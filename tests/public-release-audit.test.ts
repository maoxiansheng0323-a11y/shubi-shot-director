...
describe("public release audit", () => {
  it("keeps the v0.9.2 editor controls contract generic and publication-safe", async () => {
    const root = fileURLToPath(new URL("../", import.meta.url));
    const releasePath = path.join(root, "docs", "releases", "v0.9.2.md");
    ...
    expect(auditText("docs/releases/v0.9.2.md", releaseSource)).toEqual([]);
  });
