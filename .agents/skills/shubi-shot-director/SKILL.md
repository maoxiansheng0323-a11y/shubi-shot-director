...
- Read [reference-guided-reconstruction.md](references/reference-guided-reconstruction.md) when supplied visual references are evidence for reconstructing an editable scene.
