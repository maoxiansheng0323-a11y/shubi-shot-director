...
Current release contract: [v0.10.0 release notes](docs/releases/v0.10.0.md).
...
The repository has historically been verified on Windows 11 Pro, 64-bit (build 26200). Fresh v0.10.0 verification evidence is recorded in [`docs/releases/v0.10.0.md`](docs/releases/v0.10.0.md). macOS and Linux are not claimed as verified for v0.10.0.
