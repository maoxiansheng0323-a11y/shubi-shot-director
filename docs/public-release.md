...
git tag -a v0.6.0 -m "Shubi Shot Director v0.6.0"
...
```powershell
gh release create v0.6.0 --repo maoxiansheng0323-a11y/shubi-shot-director --title "Shubi Shot Director v0.6.0" --notes-file docs/releases/v0.6.0.md
```
