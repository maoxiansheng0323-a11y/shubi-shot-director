...
git tag -a v0.9.3 -m "Shubi Shot Director v0.9.3"
...
```powershell
gh release create v0.9.3 --repo maoxiansheng0323-a11y/shubi-shot-director --title "Shubi Shot Director v0.9.3" --notes-file docs/releases/v0.9.3.md
```
