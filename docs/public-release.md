...
git tag -a v0.9.4 -m "Shubi Shot Director v0.9.4"
...
```powershell
gh release create v0.9.4 --repo maoxiansheng0323-a11y/shubi-shot-director --title "Shubi Shot Director v0.9.4" --notes-file docs/releases/v0.9.4.md
```
