...
git tag -a v0.5.0 -m "Shubi Shot Director v0.5.0"
...
```powershell
gh release create v0.5.0 --repo maoxiansheng0323-a11y/shubi-shot-director --title "Shubi Shot Director v0.5.0" --notes-file docs/releases/v0.5.0.md
```
